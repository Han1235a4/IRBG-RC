...
$$
\begin{cases}
x(t) = (1-\alpha)x(t-1) + \alpha\tanh\left(W_{bg}^{T}W_{in}u(t) + Wx(t-1)\right)
\end{cases}
$$
...
$$
\begin{cases}
x^{(1)}(t) = (1-\alpha_1)x^{(1)}(t-1) + \alpha_1\tanh\left(W_{bg}^{(1)T}W_{in}^{(1)}u(t) + W^{(1)}x^{(1)}(t-1)\right), \\
x^{(l)}(t) = (1-\alpha_l)x^{(l)}(t-1) + \alpha_l\tanh\left(W_{bg}^{(l)T}W_{in}^{(l)}u(t) + W_p^{(l-1)}x^{(l-1)}(t) + W^{(l)}x^{(l)}(t-1)\right), \quad l=2,\ldots,L.
\end{cases}
$$
...
$$
\begin{cases}
x(t) = \beta\tanh\left(\rho Wx(t-1) + W_{bg}^{T}W_{in}u(t) + b\right) + (1-\beta)Ox(t-1)
\end{cases}
$$
...
$$
\begin{cases}
x^{(1)}(t) = \tanh\left(W^{(1)}x^{(1)}(t-1) + W_{bg}^{(1)T}W_{in}^{(1)}u(t) + W_{12}x^{(2)}(t-1)\right), \\
x^{(2)}(t) = \tanh\left(W^{(2)}x^{(2)}(t-1) + W_{bg}^{(2)T}W_{in}^{(2)}u(t) + W_{21}x^{(1)}(t-1)\right).
\end{cases}
$$
...
|---|---|---|---|---|---|---|---|---|
| **Leaky-RC** | $\{100,200,300,400,500\}$ | -- | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{0.001,0.01,0.1,1.0\}$ | $\{0.001,0.01,0.1,1.0\}$ | -- | -- | $[-1,1]$ |
| **Deep RC** | $\{100,200,300,400,500\}$ per layer | $\{2,4,5,10\}$ | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{0.001,0.01,0.1,1.0\}$ | $\{0.001,0.01,0.1,1.0\}$ | -- | -- | $[-1,1]$ |
| **ES$$^2$$N** | $\{100,200,300,400,500\}$ | -- | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{1.0,0.1,0.01,0.001\}$ | -- | $\{0.001,0.01,0.1,1.0\}$ | $\{1.0,0.1,0.01,0.001\}$ | $[-1,1]$ |
| **MCI-ESN** | $\{100,200,300,400,500\}$ per module | -- | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{0.001,0.01,0.1,1.0\}$ | -- | -- | -- | $[-1,1]$ |
