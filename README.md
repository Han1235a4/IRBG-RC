...
| **Deep RC** | $\{100,200,300,400,500\}$ | $\{2,4,5,10\}$ | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{0.001,0.01,0.1,1.0\}$ | $\{0.001,0.01,0.1,1.0\}$ | -- | -- | $\{-1,...,-0.1,0,0.1,...,1\} |
| **ES$$^2$$N** | $\{100,200,300,400,500\}$ | -- | $\{0.1,0.3,0.5,0.7,0.9,1.1,1.3,1.5\}$ | $\{1.0,0.1,0.01,0.001\}$ | -- | $\{0.001,0.01,0.1,1.0\}$ | $\{1.0,0.1,0.01,0.001\}$ |$\{-1,...,-0.1,0,0.1,...,1\} |
